  ...
  return (
    <main className="px-4 py-8">
      <div className="mx-auto w-full max-w-3xl space-y-4 rounded-2xl border border-zinc-700 bg-zinc-800/80 p-6 shadow-xl">
        <div>
          <h1 className="text-xl font-semibold text-zinc-100">Live-kategorier</h1>
          <p className="mt-1 text-sm text-zinc-400">Välj en kategori för att visa kanaler.</p>
        </div>
